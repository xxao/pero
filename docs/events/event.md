...
## SizeEvt(**kwargs)
**Inheritance:** [Event](event.md#Event) <- [ViewEvt](event.md#ViewEvt)
...
## KeyDownEvt(**kwargs)
**Inheritance:** [Event](event.md#Event) <- [ViewEvt](event.md#ViewEvt) <- [KeyEvt](event.md#KeyEvt)
...
**Inheritance:** [Event](event.md#Event) <- [ViewEvt](event.md#ViewEvt) <- [MouseEvt](event.md#MouseEvt)
