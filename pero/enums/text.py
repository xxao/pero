...
TEXT_ROTATION_NONE = NONE
TEXT_ROTATION_FOLLOW = FOLLOW
TEXT_ROTATION_NATURAL = NATURAL
TEXT_ROTATION_FACEOUT = FACEOUT
TEXT_ROTATION_FACEIN = FACEIN

TEXT_ROTATION = Enum(
    NONE = TEXT_ROTATION_NONE,
    FOLLOW = TEXT_ROTATION_FOLLOW,
    NATURAL = TEXT_ROTATION_NATURAL,
    FACEOUT = TEXT_ROTATION_FACEOUT,
    FACEIN = TEXT_ROTATION_FACEIN)
